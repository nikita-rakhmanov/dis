...
This module uses MediaPipe and OpenCV to track hands and recognize gestures
from webcam input. It displays hand landmarks and detected gestures with
labeled boxes.
"""
...
class HandTracker:
    ...
    def get_finger_state(self, landmarks, handedness) -> Dict[str, bool]:
        ...
        # Compare x-coordinate instead of y-coordinate
